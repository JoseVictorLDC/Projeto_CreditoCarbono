...
import { uploadJSONToIPFS } from "../../../pinatas/SaoPaulo1.js";
...
function SaoPaulo1(props: Props) {

    const [data, updateData] = useState([]);
    const [dataFetched, updateFetched] = useState(false);
    const [message, updateMessage] = useState('');
    const [formParams, updateFormParams] = useState({ price: '0.01' });
    ...
    async function listNFT(e) {
        ...
        try {
            ...
            let transaction = await contract.createToken(metadataURL, price, true, 0, { value: listingPrice })
    ...
    async function getAllNFTs() {
        ...
        let contract = new ethers.Contract(Marketplace.address, Marketplace.abi, signer)
        //create an NFT Token
        let transaction = await contract.getAllNFTs(0)
